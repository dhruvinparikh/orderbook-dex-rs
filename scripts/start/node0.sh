...
$path/dnachain --bootnodes /ip4/127.0.0.1/tcp/3034/p2p/QmTBup8mUZcNkytxTgz1xWxQNPFQFh5Gnwjdy19D1BPqpd /ip4/127.0.0.1/tcp/3035/p2p/QmSm4yua8ift1AULVisKooPwviVybuRFadr9Rmqurn5DWw --validator --ws-port 9945 --port 3033 --name "DNA NODE 0" --node-key 92ea498a16084a1e88abf1b3c31b03a545ee608bc2686e64eeb670a237ad427c -d /tmp/chain/acc0 --chain $path/spec.json --rpc-cors all --telemetry-url ws://telemetry.mvsdna.com:8000/submit
fi