...
$path/dnachain --validator --ws-port 9946 --port 3034 --node-key 569256cbfd3692f68085c34b19b82dd2c5951df4a802cd714b3ea798b83fe648 --name "DNA NODE 1" -d /tmp/chain/acc1 --bootnodes /ip4/127.0.0.1/tcp/3033/p2p/Qmece3bstSKgRomhPcAWswQMUFT3GRL5XpCuy8bFDggrwV /ip4/127.0.0.1/tcp/3035/p2p/QmSm4yua8ift1AULVisKooPwviVybuRFadr9Rmqurn5DWw --chain $path/spec.json --telemetry-url --telemetry-url ws://telemetry.mvsdna.com:8000/submit
fi