...
$path/target/debug/dnachain --validator --ws-port 9946 --port 3034 --name "DNA NODE 1" -d /tmp/acc1 --bootnodes /ip4/192.168.0.13/tcp/3033/p2p/Qmece3bstSKgRomhPcAWswQMUFT3GRL5XpCuy8bFDggrwV --chain $path/build-spec.dna.json --telemetry-url ws://localhost:8000/submit
fi